...
// Keep tracks of number of words in dictionary
...
bool check(const char *word)
{
    ...
    // Convert string to its lowercase representation
...
bool load(const char *dictionary)
{
    ...
    while (fscanf(file, "%s", buffer) != EOF)
    {
        ...
        // Dict should contain only lowercase letters.
...
// Make a singly linked list node
node_t make_node(const char *key)
{
